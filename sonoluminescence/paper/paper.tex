...
The dynamics of the bubble's wall, determined by the RP equations (eq. \ref{eq:RP_2} and eq. \ref{eq:RP_3}), require the pressure inside the bubble as input. To that end, we now examine the physics of the \emph{bubble's interior}. Our goal for this section is to find a suitable form for $\Delta p(t)$ in the RP equations.
